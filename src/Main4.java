...
public class Main4 {
	...
	public static void main (String args[]) throws IOException {
		...
		while (opcion != ('S') && opcion != ('s'))
		{
			...
			{
				System.out.print("\n--------------------------------------------------------------------\n");
				System.out.print("\nHas elegido Habitante, ¿que quieres hacer ahora? [L]eer datos desde el archivo, [R]ellenar datos y mostrarlos en pantalla: ");
				valorintroducido = sc.next();
				...
				if (opcion2=='L' || opcion2=='l')
				{
					...
					BufferedReader br = new BufferedReader(new FileReader("/home/jon/proyectosjava/java2_elecciones/archivos/censo.txt"));
	   				ArrayList <Habitante> array_habitantes = new ArrayList <Habitante>();	
	   				String linea = br.readLine();
					// Guardar los objetos de tipo partido en array_habitantes
					while (linea!= null)
						{
							String [] linea_separada = linea.split(", ");
		  					Habitante habitante1 = new Habitante();
		   					habitante1.setNombre(linea_separada[0]);
		   					habitante1.setEdad(Integer.parseInt(linea_separada[1]));
		   					habitante1.setDireccion(linea_separada[2]);
		   					habitante1.setTelefono(linea_separada[3]);
		   					habitante1.setDni(linea_separada[4]);
							array_habitantes.add(habitante1);
	   						linea = br.readLine();
						}
						// Mostrar los datos de los partidos que estan dentro del ArrayList
						int cantidad_habitantes = array_habitantes.size();
						// Mostrar cantidad de partidos en el array
						System.out.print("\nNumero de elementos en el ArrayList = " + cantidad_habitantes + "\n");
						System.out.print("\nAhora se mostraran los nombres de los partidos dentro del ArrayList:\n");
						int i = 0;
						for (i=0; i<array_habitantes.size();i++)
						{
							// Obtendra el nombre de cada objeto de tipo partido dentro del ArrayList
							Habitante habitante_obtenido = array_habitantes.get(i);
								if (habitante_obtenido.getEdad() >= 18)
								{
									System.out.print("\nNombre = " + habitante_obtenido.getNombre() + "\n");
									System.out.print("Edad = " + habitante_obtenido.getEdad() + "\n");
									System.out.print("Direccion = " + habitante_obtenido.getDireccion() + "\n");
									System.out.print("Telefono = " + habitante_obtenido.getTelefono() + "\n");
									System.out.print("DNI = " + habitante_obtenido.getDni() + "\n");
								}
						}
						// Vaciar el ArrayList
						array_habitantes.clear();
						// Numero de partidos despues de vaciar el Arraylist
						System.out.print("\nNumero de elementos en el Arraylist despues de vaciarlo = " + array_habitantes.size() + "\n");
						br.close();
					// Volver a preguntar que hacer
						System.out.print("\n--------------------------------------------------------------------\n");
						System.out.print("\nOperacion finalizada.\n");
					...
					while (linea!= null)
						{
							String [] linea_separada = linea.split(", ");
		  					Partido partido1 = new Partido();
		   					partido1.setNombre(linea_separada[0]);
		   					partido1.setIdeologia(linea_separada[1]);
		   					partido1.setCandidato(linea_separada[2]);
		   					partido1.setMiembros(Integer.parseInt(linea_separada[3]));
		   					partido1.setMandato(Boolean.parseBoolean(linea_separada[4]));
						...
						for (i=0; i<array_partidos.size();i++)
						{
							...
							System.out.print("\nNombre del partido = " + partido_obtenido.getNombre() + "\n");
							System.out.print("Ideologia = " + partido_obtenido.getIdeologia() + "\n");
							System.out.print("Candidato = " + partido_obtenido.getCandidato() + "\n");
							System.out.print("Miembros = " + partido_obtenido.getMiembros() + "\n");
							System.out.print("En mandato = " + partido_obtenido.getMandato() + "\n");
						}
						// Vaciar el ArrayList
